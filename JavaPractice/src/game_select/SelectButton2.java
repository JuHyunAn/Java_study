...
public class SelectButton2 implements Showable2 {	// 슬라임 버튼
	...
	public SelectButton2() {
		// TODO Auto-generated constructor stub
		// 버튼 클릭, 버튼 on-off 상태 설정
		stateValue = STATE_OFF;
		
		try {
				buttonImg1 = ImageIO.read(new File("res/image/chapter_bt2.png"));
				buttonImg2 = ImageIO.read(new File("res/image/chapter_bt2_2.png"));
				buttonImg3 = ImageIO.read(new File("res/image/chapter_bt2_3.png"));
		} catch (IOException e) {
