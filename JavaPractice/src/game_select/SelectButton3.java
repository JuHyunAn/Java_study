...
public class SelectButton3 implements Showable2 {
	...
	public SelectButton3() {
		// TODO Auto-generated constructor stub
		// 버튼 클릭, 버튼 on-off 상태 설정
		stateValue = STATE_OFF;
		
		try {
				buttonImg1 = ImageIO.read(new File("res/image/chapter_bt4.png"));
				buttonImg2 = ImageIO.read(new File("res/image/chapter_bt4_2.png"));
				buttonImg3 = ImageIO.read(new File("res/image/chapter_bt4_3.png"));
		} catch (IOException e) {
